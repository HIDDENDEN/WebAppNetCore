...
namespace ImgProcLib
{
    ...
    public class ReturnMessage
    {
        ...
        public ReturnMessage(string filePath, string predictionStringResult)//, byte[] byteImage)
        {
